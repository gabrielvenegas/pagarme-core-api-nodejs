...
class RecipientsController {
   ...
   * @returns {Promise}
   */
  static getTransfer(recipientId = "", transferId, callback = undefined) {
    ...
    return new Promise((_fulfill, _reject) => {
      _request(_options, (_error, _response, _context) => {
        ...
        if (_error) {
          ...
          parsed = _baseController
            .getObjectMapper()
            .mapObject(parsed, "GetTransferResponse");
    ...
    return new Promise((_fulfill, _reject) => {
      _request(_options, (_error, _response, _context) => {
        ...
        if (_error) {
          ...
          parsed = _baseController
            .getObjectMapper()
            .mapObject(parsed, "GetRecipientResponse");
          _callback(null, parsed, _context);
          _fulfill(parsed);
        } else {
          errorResponse = _baseController.validateResponse(_context);
    ...
    return new Promise((_fulfill, _reject) => {
      _request(_options, (_error, _response, _context) => {
        ...
        if (_error) {
          ...
          parsed = _baseController
            .getObjectMapper()
            .mapObject(parsed, "GetAnticipationResponse");
          _callback(null, parsed, _context);
          _fulfill(parsed);
        } else {
          errorResponse = _baseController.validateResponse(_context);
   ...
   * @returns {Promise}
   */
  static getRecipients(page = "", size, callback = undefined) {
    // create empty callback if absent
    const _callback =
      typeof callback === "function" ? callback : () => undefined;
    ...
    return new Promise((_fulfill, _reject) => {
      _request(_options, (_error, _response, _context) => {
        ...
        if (_error) {
          ...
          parsed = _baseController
            .getObjectMapper()
            .mapObject(parsed, "ListRecipientResponse");
          _callback(null, parsed, _context);
          _fulfill(parsed);
        } else {
          errorResponse = _baseController.validateResponse(_context);
   ...
   * @returns {Promise}
   */
  static getWithdrawById(recipientId = "", withdrawalId, callback = undefined) {
    // create empty callback if absent
    const _callback =
      typeof callback === "function" ? callback : () => undefined;
    ...
    return new Promise((_fulfill, _reject) => {
      _request(_options, (_error, _response, _context) => {
        ...
        if (_error) {
          ...
          parsed = _baseController
            .getObjectMapper()
            .mapObject(parsed, "GetWithdrawResponse");
          _callback(null, parsed, _context);
          _fulfill(parsed);
        } else {
          errorResponse = _baseController.validateResponse(_context);
   ...
   * @returns {Promise}
   */
  static updateRecipientDefaultBankAccount(
    recipientId = "",
    request,
    idempotencyKey,
    callback = undefined
   ...
   * @returns {Promise}
   */
  static updateRecipientMetadata(
    recipientId = "",
    request,
    idempotencyKey,
    callback = undefined
    ...
    return new Promise((_fulfill, _reject) => {
      _request(_options, (_error, _response, _context) => {
        ...
        if (_error) {
          ...
          parsed = _baseController
            .getObjectMapper()
            .mapObject(parsed, "ListTransferResponse");
          _callback(null, parsed, _context);
          _fulfill(parsed);
        } else {
          errorResponse = _baseController.validateResponse(_context);
   ...
   * @returns {Promise}
   */
  static createWithdraw(recipientId = "", request, callback = undefined) {
    // create empty callback if absent
    const _callback =
      typeof callback === "function" ? callback : () => undefined;
   ...
   * @returns {Promise}
   */
  static updateAutomaticAnticipationSettings(
    recipientId = "",
    request,
    idempotencyKey,
    callback = undefined
   ...
   * @returns {Promise}
   */
  static updateRecipientTransferSettings(
    recipientId = "",
    request,
    idempotencyKey,
    callback = undefined
  ...
  static getAnticipations(
    ...
    _queryBuilder = _apiHelper.appendUrlWithQueryParameters(_queryBuilder, {
      ...
      status,
      timeframe,
      payment_date_since: _apiHelper.stringifyDateTime(
        paymentDateSince,
        "rfc3339"
      ),
      payment_date_until: _apiHelper.stringifyDateTime(
        paymentDateUntil,
        "rfc3339"
      ),
      created_since: _apiHelper.stringifyDateTime(createdSince, "rfc3339"),
    ...
    return new Promise((_fulfill, _reject) => {
      _request(_options, (_error, _response, _context) => {
        ...
        if (_error) {
          ...
          parsed = _baseController
            .getObjectMapper()
            .mapObject(parsed, "ListAnticipationResponse");
          _callback(null, parsed, _context);
          _fulfill(parsed);
        } else {
          errorResponse = _baseController.validateResponse(_context);
   ...
   * @returns {Promise}
   */
  static getRecipient(recipientId = "", callback = undefined) {
    // create empty callback if absent
    const _callback =
      typeof callback === "function" ? callback : () => undefined;
    ...
    return new Promise((_fulfill, _reject) => {
      _request(_options, (_error, _response, _context) => {
        ...
        if (_error) {
          ...
          parsed = _baseController
            .getObjectMapper()
            .mapObject(parsed, "ListWithdrawals");
          _callback(null, parsed, _context);
          _fulfill(parsed);
        } else {
          errorResponse = _baseController.validateResponse(_context);
   ...
   * @returns {Promise}
   */
  static getBalance(recipientId = "", callback = undefined) {
    // create empty callback if absent
    const _callback =
      typeof callback === "function" ? callback : () => undefined;
    ...
    return new Promise((_fulfill, _reject) => {
      _request(_options, (_error, _response, _context) => {
        ...
        if (_error) {
          ...
          parsed = _baseController
            .getObjectMapper()
            .mapObject(parsed, "GetBalanceResponse");
          _callback(null, parsed, _context);
          _fulfill(parsed);
        } else {
          errorResponse = _baseController.validateResponse(_context);
   ...
   * @returns {Promise}
   */
  static getRecipientByCode(code = "", callback = undefined) {
    // create empty callback if absent
    const _callback =
      typeof callback === "function" ? callback : () => undefined;
